        ...
        <div style="margin:30px auto; width:300px; height:300px; background:#ffffff;">
          ...
          <div class="style_1">
            <form method="get" id="searchform" action="">
              ...
              <fieldset>
                <input id="s2" name="passwd" type="password" value="Enter password" class="password_input" onblur="if(this.value=='Enter password'){this.value='Enter password';}" onfocus="if(this.value =='Enter password') {this.value=''; }" />
              </fieldset>
              <fieldset>
